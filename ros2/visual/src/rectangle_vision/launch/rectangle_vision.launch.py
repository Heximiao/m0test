...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("exposure", default_value="100.0"),
            DeclareLaunchArgument("gain", default_value="-1.0"),
            DeclareLaunchArgument("brightness", default_value="-1.0"),
            DeclareLaunchArgument("control_period_sec", default_value="0.02"),
            DeclareLaunchArgument("yaw_gain", default_value="0.25"),
            DeclareLaunchArgument("pitch_gain", default_value="0.40"),
            DeclareLaunchArgument("maximum_rate_deg_s", default_value="180.0"),
                ...
                parameters=[
                    {
                        ...
                        "pitch_gain": LaunchConfiguration("pitch_gain"),
                        "maximum_rate_deg_s": LaunchConfiguration("maximum_rate_deg_s"),

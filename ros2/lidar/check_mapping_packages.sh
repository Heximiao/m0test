...
echo "=== apt candidates ==="
apt-cache search '^ros-lyrical-' | grep -Ei 'slam|toolbox|nav2|navigation|map-server|amcl|robot-localization|joint-state|xacro|tf2|laser|cartographer|mapper|localization|teleop|twist|rviz' | sort || true

...
build-1111993982: ../gpio_toggle_output.syscfg
	...
	"C:/TI/sysconfig_1.26.2/sysconfig_cli.bat" -s "C:/TI/mspm0_sdk_2_10_00_04/.metadata/product.json" --script "C:/Users/14166/workspace_ccstheia/gpio_toggle_output/gpio_toggle_output.syscfg" -o "." --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

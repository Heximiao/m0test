...
#define LINE_LOST_SPEED_SCALE (0.65f) /* 巡线丢线时的速度缩放比例 */
...
#define LINE_FOLLOW_MAX_COUNTS (15.0f) /* 巡线自动前进速度上限，单位：counts/20ms */

#define LTURN_TARGET_COUNTS_90 (275.0f) /* 90 degree in-place turn encoder target. */
